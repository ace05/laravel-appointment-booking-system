...
@section('title')
   {{{  __('site_register_as_service_provider') }}}
@endsection
            ...
            <div class="col-md-8">               
                <div class="card card-signin mt-2">
                    <div class="card-body">
                        ...
                        {!! Form::open(['url' => route('site.service.provider.register'), 'class' => 'row']) !!}
                            <div class="col-md-12">
                                <div class="form-group">
                                    {!! Form::label('service_provider_name', __('site_service_provider_name')) !!}
                                    {!! Form::text('service_provider_name', null, ['class' => $errors->has('service_provider_name') ? 'form-control form-control-lg is-invalid' : 'form-control form-control-lg', 'placeholder' =>  __('site_service_provider_name')]) !!}
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::select('city_id[]', $cities ,null, ['class' => $errors->has('city_id') ? 'form-control form-control-lg is-invalid select2' : 'form-control form-control-lg select2','multiple' => 'multiple']) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::select('profession[]', $subCategories ,null, ['class' => $errors->has('city_id') ? 'form-control form-control-lg is-invalid select2' : 'form-control form-control-lg select2','multiple' => 'multiple']) !!}
                                ...
                                <div class="form-group">
                                    {!! Form::label('about', __('site_about_service_provider') ,['class' => 'control-label']); !!}
