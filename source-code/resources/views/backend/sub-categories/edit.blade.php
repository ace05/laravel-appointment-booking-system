...
<div class="row">
    <div class="col-md-8">
      <div class="tile">
        <div class="tile-body">
            {!! Form::open(['url' => route('admin.subcategories.edit', ['id' => $category->id]), 'files' => true]) !!}
                ...
                <div class="form-group">
                    ...
                    {!! Form::select('service_category_id', $categories, $category->service_category_id, ['class' => 'form-control']) !!}
